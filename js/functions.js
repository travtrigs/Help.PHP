...
!function(a) {
    ...
    a.extend(a.fn, {
        ...
        messages: {
            ...
            maxlength: a.validator.format("Must be at most {0} characters"),
            minlength: a.validator.format("Must be at least {0} characters"),
            rangelength: a.validator.format("Must be between {0} and {1} characters"),
            range: a.validator.format("Must be between {0} and {1}"),
            max: a.validator.format("Must be less than or equal to {0}"),
            min: a.validator.format("Must be greater than or equal to {0}")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function() {
...
$('document').ready(function() {
    $('.button_in').click(function() {
        $('.sign_in').delay(200).fadeIn(200);
    });
    $('.button_up').click(function() {
        $('.sign_up').delay(200).fadeIn(200);
    });
    $('.container').click(function() {
        $('#sign_in').fadeOut(200);
        $('#sign_up').fadeOut(200);
        $('button').delay(200).fadeIn(200);
    });
});
/***********************************************Sign In Function******************************************************/
$(document).ready(function() {
    $('#sign_in').validate( {
        ...
        submitHandler: function(form) {
            ...
            $.ajax( {
                ...
                data: dataString,
                cache: false,
                beforeSend: function() { $("#submit_in").val('Signing In...'); },
                success: function(data) {
                    if(data) {
                        $(".box").fadeOut('slow', function() {
                            $(".box").load("home.php", function() {
                                $(".box").fadeIn('slow');
                            });
                        });
                    }
...
$(document).ready(function() {
  $("#sign_up").validate( {
    rules: {
      username_up: { required: true, minlength: 4, remote: { url: 'connect.php', type: 'POST' }},
    ...
    submitHandler: function(form) {
      ...
      $.ajax( {
        ...
        data: dataString,
        cache: false,
        beforeSend: function() { $("#submit_up").val('Signing Up...'); },
        success: function(data) {
          if(data) {
            $(".box").fadeOut('slow', function() {
                $(".box").load("home.php", function() {
